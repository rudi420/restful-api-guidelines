...
[#218]
== icon:question-circle[1x] {MUST} contain API meta information
...
[#116]
== icon:question-circle[1x] {MUST} use semantic versioning
...
[#215]
== icon:question-circle[1x] {MUST} provide API identifiers
...
[#219]
== icon:question-circle[1x] {MUST} provide API audience
...
[#223]
== icon:question-circle[1x] {MUST-SHOULD-MAY} use functional naming schema
...
[#224]
== icon:question-circle[1x] {MUST} follow naming convention for hostnames
