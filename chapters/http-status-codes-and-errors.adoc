...
[#243]
== icon:question-circle[1x] {MUST} use official HTTP status codes
...
[#151]
== icon:question-circle[1x] {MUST} specify success and error responses
...
[#150]
== icon:question-circle[1x] {SHOULD} only use most common HTTP status codes
...
==== icon:question-circle[1x] {do-not-use}
...
[#220]
== icon:question-circle[1x] {MUST} use most specific HTTP status codes
...
[#152]
== icon:question-circle[1x] {MUST} use code 207 for batch or bulk requests
...
[#153]
== icon:question-circle[1x] {MUST} use code 429 with headers for rate limits
...
[#176]
== icon:question-circle[1x] {MUST} support problem JSON
...
[#177]
== icon:question-circle[1x] {MUST} not expose stack traces
...
[#251]
== icon:question-circle[1x] {SHOULD} not use redirection codes
