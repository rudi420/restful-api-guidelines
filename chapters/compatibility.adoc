...
[#106]
== icon:question-circle[1x] {MUST} not break backward compatibility
...
[#107]
== icon:question-circle[1x] {SHOULD} prefer compatible extensions
...
[#109]
== icon:question-circle[1x] {SHOULD} design APIs conservatively
...
[#108]
== icon:question-circle[1x] {MUST} prepare clients to accept compatible API extensions
...
[#111]
== icon:question-circle[1x] {MUST} treat OpenAPI specification as open for extension by default
...
[#113]
== icon:question-circle[1x] {SHOULD} avoid versioning
...
[#114]
== icon:question-circle[1x] {MUST} use media type versioning
...
[#115]
== icon:question-circle[1x] {MUST} not use URL versioning
...
[#110]
== icon:question-circle[1x] {MUST} always return JSON objects as top-level data structures
...
[#112]
== icon:question-circle[1x] {SHOULD} used open-ended list of values (`x-extensible-enum`) for enumerations
