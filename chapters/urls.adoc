...
[#135]
== icon:question-circle[1x] {SHOULD} not use /api as base path
...
[#134]
== icon:question-circle[1x] {MUST} pluralize resource names
...
[#228]
== icon:question-circle[1x] {MUST} use URL-friendly resource identifiers
...
[#129]
== icon:question-circle[1x] {MUST} use kebab-case for path segments
...
[#136]
== icon:question-circle[1x] {MUST} use normalized paths without empty path segments and trailing slashes
...
[#141]
== icon:question-circle[1x] {MUST} keep URLs verb-free
...
[#138]
== icon:question-circle[1x] {MUST} avoid actions — think about resources
...
[#140]
== icon:question-circle[1x] {SHOULD} define _useful_ resources
...
[#142]
== icon:question-circle[1x] {MUST} use domain-specific resource names
...
[#139]
== icon:question-circle[1x] {SHOULD} model complete business processes
...
[#143]
== icon:question-circle[1x] {MUST} identify resources and sub-resources via path segments
...
[#241]
== icon:question-circle[1x] {MAY} expose compound keys as resource identifiers
...
[#145]
== icon:question-circle[1x] {MAY} consider using (non-) nested URLs
...
[#146]
== icon:question-circle[1x] {SHOULD} limit number of resource types
...
[#147]
== icon:question-circle[1x] {SHOULD} limit number of sub-resource levels
...
[#130]
== icon:question-circle[1x] {MUST} use snake_case (never camelCase) for query parameters

See also <<118>>.

[#137]
== icon:question-circle[1x] {MUST} stick to conventional query parameters
