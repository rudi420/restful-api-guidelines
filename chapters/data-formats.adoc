...
[#238]
== icon:question-circle[1x] {MUST} use standard data formats
...
[#171]
== icon:question-circle[1x] {MUST} define a format for number and integer types
...
[#239]
=== icon:question-circle[1x] {MUST} encode binary data in `base64url`
...
[#126]
[#169]
== icon:question-circle[1x] {MUST} use standard formats for date and time properties
...
[#255]
== icon:question-circle[1x] {SHOULD} select appropriate one of date or date-time format
...
[#127]
== icon:question-circle[1x] {SHOULD} use standard formats for time duration and interval properties
...
[#128]
[#170]
== icon:question-circle[1x] {MUST} use standard formats for country, language and currency properties
...
[#244]
== icon:question-circle[1x] {SHOULD} use content negotiation, if clients may choose from different resource representations
...
[#144]
== icon:question-circle[1x] {SHOULD} only use UUIDs if necessary
