...
[#187]
== icon:question-circle[1x] {MUST} reflect deprecation in API specifications
...
[#185]
== icon:question-circle[1x] {MUST} obtain approval of clients before API shut down
...
[#186]
== icon:question-circle[1x] {MUST} collect external partner consent on deprecation time span
...
[#188]
== icon:question-circle[1x] {MUST} monitor usage of deprecated API scheduled for sunset
...
[#189]
== icon:question-circle[1x] {SHOULD} add `Deprecation` and `Sunset` header to responses
...
[#190]
== icon:question-circle[1x] {SHOULD} add monitoring for `Deprecation` and `Sunset` header
...
[#191]
== icon:question-circle[1x] {MUST} not start using deprecated APIs
