...
[#148]
== icon:question-circle[1x] {MUST} use HTTP methods correctly
...
[#149]
== icon:question-circle[1x] {MUST} fulfill common method properties
...
[#229]
== icon:question-circle[1x] {SHOULD} consider to design `POST` and `PATCH` idempotent
...
[#231]
== icon:question-circle[1x] {Should} use secondary key for idempotent `POST` design
...
[#253]
== icon:question-circle[1x] {MAY} support asynchronous request processing
...
[#154]
== icon:question-circle[1x] {MUST} define collection format of header and query parameters
...
[#236]
== icon:question-circle[1x] {SHOULD} design simple query languages using query parameters
...
[#237]
== icon:question-circle[1x] {SHOULD} design complex query languages using JSON
...
[#226]
== icon:question-circle[1x] {MUST} document implicit response filtering
