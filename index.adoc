...
= Zalando RESTful API and Event Guidelines (prepare for KNISTR in progress...)
...
image:assets/KNISTR.png[] KNISTR approval status is marked by the following icons in the headlines
[horizontal]
